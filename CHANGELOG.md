...
- Added draft-based GitHub release preparation with plain numeric tags such as `0.1.0`: write Markdown notes and choose release/pre-release in the release editor, build and attach both installation ZIPs with checksums, then publish. Publishing also triggers the versioned metrics image build.
